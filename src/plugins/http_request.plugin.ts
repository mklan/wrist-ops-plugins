...
const plugin: Plugin = {
  ...
  options: {
    transformContext: {
      ...
      description:
        "Optional JS function as a string. It will be evaluated and called with the context, and its return value will be deep merged into the current context.",
    },
    url: {
      type: "string",
      label: "Endpoint URL",
